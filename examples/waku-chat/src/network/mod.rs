...
/// Node logic handler
/// Composed of a mock network client to communicate with other nodes and a custom mempool
/// It's main task is to boostrap everything necessary for a glacier simulation.
